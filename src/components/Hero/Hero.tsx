  ...
  return (
    <section className={styles.hero}>
      <div>
        ...
        <p className={styles.hero_text}>Зателефонуйте мені уже сьогодні і я допоможу Вам відновити ваш телевізор! Або напишіть в месенджер в будь-який зручний для вас час.</p>
        <ul>
